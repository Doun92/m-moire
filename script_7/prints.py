...
print(EvolutionPhonetique.evolution_phonetique("MÁSCLO"))       #masle
...
print(EvolutionPhonetique.evolution_phonetique("NÁNUS"))        #nain 2
print(EvolutionPhonetique.evolution_phonetique("NÁSUS"))        #nez 2
print(EvolutionPhonetique.evolution_phonetique("GRÁNUS"))       #grain 2
...
print(EvolutionPhonetique.evolution_phonetique("HĘRI"))         #ier 2
print(EvolutionPhonetique.evolution_phonetique("MĘI"))          #mi 2
...
print(EvolutionPhonetique.evolution_phonetique("CẸSTI"))        #cist 2
print(EvolutionPhonetique.evolution_phonetique("FỌSTI"))        #fus 2
print(EvolutionPhonetique.evolution_phonetique("TỌTTI"))        #tuit 2
print(EvolutionPhonetique.evolution_phonetique("FỌI"))          #fui 2
...
print(EvolutionPhonetique.evolution_phonetique("DỌLCE"))      #dolz 2
...
print(EvolutionPhonetique.evolution_phonetique("DYỌRNU"))    #jorn 2
...
print(EvolutionPhonetique.evolution_phonetique("RÍSUS"))         #ris 2
print(EvolutionPhonetique.evolution_phonetique("BỌNU"))         #bon 2
...
print(EvolutionPhonetique.evolution_phonetique("BÚTYRU"))         #burre 2
...
print(EvolutionPhonetique.evolution_phonetique("QUẸD"))         #quei 2
...
print(EvolutionPhonetique.evolution_phonetique("PỌNRE"))         #pondre 2
print(EvolutionPhonetique.evolution_phonetique("SPÍNLA"))         #espingle 2
print(EvolutionPhonetique.evolution_phonetique("VẸNI"))         #vin 2
...
print(EvolutionPhonetique.evolution_phonetique("CǪRBU"))         #corp 2
...
print(EvolutionPhonetique.evolution_phonetique("ÁLTU"))         #haut 2
...
print(EvolutionPhonetique.evolution_phonetique("MǪLRE"))         #moudre 2
print(EvolutionPhonetique.evolution_phonetique("CỌPPA"))         #cope 2
...
print(EvolutionPhonetique.evolution_phonetique("PRÍNCPE"))    #prince 2
...
print(EvolutionPhonetique.evolution_phonetique("HABWẸMUS"))     #eumes
...
print(EvolutionPhonetique.evolution_phonetique("FẸMINA"))   #feme 3
print(EvolutionPhonetique.evolution_phonetique("DỌMINA"))   #dame 3
print(EvolutionPhonetique.evolution_phonetique("PERDĘSTI"))     #perdies 3
print(EvolutionPhonetique.evolution_phonetique("PǪTUI"))        #poi 3
...
print(EvolutionPhonetique.evolution_phonetique("PĘIOR"))        #pire 3
print(EvolutionPhonetique.evolution_phonetique("MĘDIU"))        #mi 3
print(EvolutionPhonetique.evolution_phonetique("TRǪIA"))        #truie 3
...
print(EvolutionPhonetique.evolution_phonetique("PǪSTIUS"))      #puis 3
print(EvolutionPhonetique.evolution_phonetique("FǪLIA"))        #fueille 3
print(EvolutionPhonetique.evolution_phonetique("CǪGNITU"))      #cointe 3
print(EvolutionPhonetique.evolution_phonetique("PRĘTIAT"))      #prise 3
print(EvolutionPhonetique.evolution_phonetique("TĘRTIA"))       #tierce 3
print(EvolutionPhonetique.evolution_phonetique("NĘPTIA"))       #niece 3
print(EvolutionPhonetique.evolution_phonetique("PĘTTIA"))       #piece 3
print(EvolutionPhonetique.evolution_phonetique("FǪRTIA"))       #force 3
print(EvolutionPhonetique.evolution_phonetique("SCǪRTEA"))      #escorce 3
print(EvolutionPhonetique.evolution_phonetique("NǪPTIAS"))      #noces 3
print(EvolutionPhonetique.evolution_phonetique("CRǪCCIA"))      #croce 3
print(EvolutionPhonetique.evolution_phonetique("SĘQUO"))        #siu 3
print(EvolutionPhonetique.evolution_phonetique("ĘQUA"))         #ive 3
print(EvolutionPhonetique.evolution_phonetique("VẸNUI"))        #vin 3
print(EvolutionPhonetique.evolution_phonetique("VǪLUI"))        #voil 3
print(EvolutionPhonetique.evolution_phonetique("PǪTUI"))        #poi 3
print(EvolutionPhonetique.evolution_phonetique("HÁBUI"))        #oi 3
...
4 SYLLABES
"""
print(EvolutionPhonetique.evolution_phonetique("KWAGOLÁRE"))    #caillier
print(EvolutionPhonetique.evolution_phonetique("ISCRÍBERE"))    #escrivre
print(EvolutionPhonetique.evolution_phonetique("PARÁOLA"))      #parole
print(EvolutionPhonetique.evolution_phonetique("SUCTIÁRE"))     #sucier
print(EvolutionPhonetique.evolution_phonetique("AURẸCULA"))     #oreille
print(EvolutionPhonetique.evolution_phonetique("CREATÚRA"))     #creature
print(EvolutionPhonetique.evolution_phonetique("LEOPARDU"))     #leupart
print(EvolutionPhonetique.evolution_phonetique("PROẸTIA"))      #proece
print(EvolutionPhonetique.evolution_phonetique("BAACULAT"))     #baaile
print(EvolutionPhonetique.evolution_phonetique("TROPATỌRE"))    #troveour
print(EvolutionPhonetique.evolution_phonetique("FEBRWÁRYO"))    #fevrier
print(EvolutionPhonetique.evolution_phonetique("ANTECĘSSOR"))       #ancestre 4
print(EvolutionPhonetique.evolution_phonetique("QWADRIFỌRCU"))      #carrefor 4
print(EvolutionPhonetique.evolution_phonetique("UNITÁTE"))          #unite 4
print(EvolutionPhonetique.evolution_phonetique("PARTIRÁYYO"))       #partrai 4
print(EvolutionPhonetique.evolution_phonetique("EPẸSCOPU"))         #evesque 4
print(EvolutionPhonetique.evolution_phonetique("IǪVENE"))           #juene 4
print(EvolutionPhonetique.evolution_phonetique("ECCLĘSIA"))     #eglise 4
print(EvolutionPhonetique.evolution_phonetique("INGĘNIU"))      #engin 4
print(EvolutionPhonetique.evolution_phonetique("IÁCUI"))        #jui 4
print(EvolutionPhonetique.evolution_phonetique("HÁBUISTI"))        #eus 4
print(EvolutionPhonetique.evolution_phonetique("PRÍMARIU"))        #premier 4
print(EvolutionPhonetique.evolution_phonetique("ADIÚTA"))        #aïe 4
print(EvolutionPhonetique.evolution_phonetique("ADIÚTET"))        #aït 4
print(EvolutionPhonetique.evolution_phonetique("CAUSIÍRE"))      #choisir 4
print(EvolutionPhonetique.evolution_phonetique("IOCÁRE"))      #joer 4
print(EvolutionPhonetique.evolution_phonetique("COMMEÁTU"))      #congié 4
print(EvolutionPhonetique.evolution_phonetique("MÁIIU"))      #mai 4
print(EvolutionPhonetique.evolution_phonetique("MAIIOR"))      #maire 4
print(EvolutionPhonetique.evolution_phonetique("PĘIIUS"))      #pis 4
print(EvolutionPhonetique.evolution_phonetique("VENUÍSTI"))         #venis 4
print(EvolutionPhonetique.evolution_phonetique("VOLPÍCULU"))         #golpil 4
print(EvolutionPhonetique.evolution_phonetique("TRIPÁLIU"))         #travail 4
print(EvolutionPhonetique.evolution_phonetique("ACCRẸSCERE"))         #acreistre 4
print(EvolutionPhonetique.evolution_phonetique("CWAGOLÁRE"))    #cailler 4
print(EvolutionPhonetique.evolution_phonetique("BATTWÁLIA"))    #bataille 4
print(EvolutionPhonetique.evolution_phonetique("CỌNSUERE"))    #cosdre 4
print(EvolutionPhonetique.evolution_phonetique("VIRDYÁRIU"))    #vergier 4
print(EvolutionPhonetique.evolution_phonetique("CANTIỌNE"))    #chançon 4
print(EvolutionPhonetique.evolution_phonetique("LECTIỌNE"))    #leçon 4
print(EvolutionPhonetique.evolution_phonetique("BASSIÁRE"))    #baissier 4
print(EvolutionPhonetique.evolution_phonetique("DIÁBOLU"))    #deable 4
print(EvolutionPhonetique.evolution_phonetique("EXCÁMBIU"))    #eschange 4
print(EvolutionPhonetique.evolution_phonetique("ROMÁNICE"))     #romanz 4
print(EvolutionPhonetique.evolution_phonetique("PLACITÁRE"))         #plaidier 4
print(EvolutionPhonetique.evolution_phonetique("COGITÁRE"))         #cuidier 4
print(EvolutionPhonetique.evolution_phonetique("ORÍGINE"))         #orine 4
print(EvolutionPhonetique.evolution_phonetique("CASTIGÁRE"))         #chastier 4
print(EvolutionPhonetique.evolution_phonetique("CORROGÁTA"))         #corvee 4
print(EvolutionPhonetique.evolution_phonetique("CARRICÁRE"))         #chargier 4
print(EvolutionPhonetique.evolution_phonetique("COLLOCÁRE"))         #couchier 4
print(EvolutionPhonetique.evolution_phonetique("MANDUCÁRE"))         #mangier 4
print(EvolutionPhonetique.evolution_phonetique("IÚDICU"))         #juge 4
print(EvolutionPhonetique.evolution_phonetique("CANỌNICU"))         #chanoine 4
print(EvolutionPhonetique.evolution_phonetique("DOMẸNICU"))         #domeine 4
print(EvolutionPhonetique.evolution_phonetique("DOMĘSTICU"))         #domesche 4
print(EvolutionPhonetique.evolution_phonetique("SUCCỌTERE"))         #secorre #4
print(EvolutionPhonetique.evolution_phonetique("ASSĘDITA"))         #assiete #4
print(EvolutionPhonetique.evolution_phonetique("TRADITỌRE"))         #trachor #4
print(EvolutionPhonetique.evolution_phonetique("MALEFÁTU"))         #maufe 4
print(EvolutionPhonetique.evolution_phonetique("PREPǪSITU"))         #prevost 4
print(EvolutionPhonetique.evolution_phonetique("CIVITÁTE"))         #cite 4
print(EvolutionPhonetique.evolution_phonetique("LIBERÁRE"))         #livrer 4
print(EvolutionPhonetique.evolution_phonetique("TENĘBRICU"))         #tenerge 4
print(EvolutionPhonetique.evolution_phonetique("QUADRLLU"))         #carrel 4
print(EvolutionPhonetique.evolution_phonetique("QUADRÁTU"))         #carre 4
print(EvolutionPhonetique.evolution_phonetique("SACRAMẸNTU"))         #sairement 4
print(EvolutionPhonetique.evolution_phonetique("WÁIGARO"))         #guaire 4
print(EvolutionPhonetique.evolution_phonetique("CARYỌPHYLU"))         #gerofle 4
print(EvolutionPhonetique.evolution_phonetique("CERCĘDULA"))         #cercele 4
print(EvolutionPhonetique.evolution_phonetique("AURẸCULA"))         #oreille 4
print(EvolutionPhonetique.evolution_phonetique("CWAGULÁRE"))         #caillier 4
print(EvolutionPhonetique.evolution_phonetique("VIGILÁRE"))         #veillier 4
print(EvolutionPhonetique.evolution_phonetique("SAPÚISTI"))         #seus 4
print(EvolutionPhonetique.evolution_phonetique("BIBÚISSET"))         #beust 4
print(EvolutionPhonetique.evolution_phonetique("MOVÚISTIS"))         #meustes 4
print(EvolutionPhonetique.evolution_phonetique("DECẸPUI"))         #deçui 4
print(EvolutionPhonetique.evolution_phonetique("POTÚISTI"))         #peus 4
print(EvolutionPhonetique.evolution_phonetique("PǪTUERUNT"))         #porent 4
print(EvolutionPhonetique.evolution_phonetique("CRẸDUERUNT"))         #crurent 4
print(EvolutionPhonetique.evolution_phonetique("ANTÍQUA"))         #antive 4
print(EvolutionPhonetique.evolution_phonetique("NOCÚISTI"))         #neus 4
print(EvolutionPhonetique.evolution_phonetique("LEGÚISSET"))         #leust 4
print(EvolutionPhonetique.evolution_phonetique("ANTÍQUU"))         #antif 4
print(EvolutionPhonetique.evolution_phonetique("ÁQUELA"))         #aigle 4
print(EvolutionPhonetique.evolution_phonetique("SĘQUERE"))         #sivre 4
print(EvolutionPhonetique.evolution_phonetique("PLÁCUERUNT"))         #plourent 4
print(EvolutionPhonetique.evolution_phonetique("LẸGUERUNT"))         #lurent 4
print(EvolutionPhonetique.evolution_phonetique("SAPIÁTIS"))         #sachiez 4
print(EvolutionPhonetique.evolution_phonetique("FLABEǪLU"))         #flajuel 4
print(EvolutionPhonetique.evolution_phonetique("PRETIÁRE"))         #preisier 4
print(EvolutionPhonetique.evolution_phonetique("RATIỌNE"))         #raison 4
print(EvolutionPhonetique.evolution_phonetique("PODIÁRE"))         #puier 4
print(EvolutionPhonetique.evolution_phonetique("INVẸDIA"))         #envie 4
print(EvolutionPhonetique.evolution_phonetique("BASIÁRE"))         #baisier 4
print(EvolutionPhonetique.evolution_phonetique("PALÁTIU"))         #palais 4
print(EvolutionPhonetique.evolution_phonetique("PERTÚSIU"))         #pertuis 4
print(EvolutionPhonetique.evolution_phonetique("LAQEÁRE"))         #lacier 4
print(EvolutionPhonetique.evolution_phonetique("CORRẸGIA"))         #correie 4
print(EvolutionPhonetique.evolution_phonetique("EXÁGIU"))         #essai 4
print(EvolutionPhonetique.evolution_phonetique("CORRẸGIU"))         #correi 4
print(EvolutionPhonetique.evolution_phonetique("CAPREǪLU"))         #chevruel 4
print(EvolutionPhonetique.evolution_phonetique("ARBÍTRIU"))         #arbitre 4
print(EvolutionPhonetique.evolution_phonetique("ACCAPTÁRE"))         #acheter 4
print(EvolutionPhonetique.evolution_phonetique("MEDẸPSIMU"))         #meesme 4
print(EvolutionPhonetique.evolution_phonetique("ÁLIQUID"))         #alque 4
print(EvolutionPhonetique.evolution_phonetique("ASSEDTÁRE"))         #asseter 4
print(EvolutionPhonetique.evolution_phonetique("FACTIỌNE"))         #façon 4
print(EvolutionPhonetique.evolution_phonetique("IECTÁRE"))         #geter  4
print(EvolutionPhonetique.evolution_phonetique("APPROBÁRE"))         #aprover 4
print(EvolutionPhonetique.evolution_phonetique("SUPPLICÁRE"))         #sopleiier 4
print(EvolutionPhonetique.evolution_phonetique("OFFẸCIU"))         #ofice 4
print(EvolutionPhonetique.evolution_phonetique("AFFRONTÁRE"))         #afronter 4
print(EvolutionPhonetique.evolution_phonetique("AVVENTÚRA"))         #aventure 4
print(EvolutionPhonetique.evolution_phonetique("BASSIÁRE"))         #baissier 4
print(EvolutionPhonetique.evolution_phonetique("MÁIIU"))         #mai 4
print(EvolutionPhonetique.evolution_phonetique("COGITÁRE"))         #cuidier 4
print(EvolutionPhonetique.evolution_phonetique("BÁIILU"))         #bail 4
print(EvolutionPhonetique.evolution_phonetique("MEDITÁTE"))         #meitie 4
...
5 SYLLABES
"""
print(EvolutionPhonetique.evolution_phonetique("GUBERNÁCULU"))      #governail 5
print(EvolutionPhonetique.evolution_phonetique("VASSALLÁTICU"))     #vasselage 5
print(EvolutionPhonetique.evolution_phonetique("DOMINICĘLLA"))      #dameisele 5
print(EvolutionPhonetique.evolution_phonetique("PARAOLÁRE"))        #parler 5
print(EvolutionPhonetique.evolution_phonetique("IMPERATỌRE"))       #empereour 5
print(EvolutionPhonetique.evolution_phonetique("AMICITÁTE"))        #amistie 5
print(EvolutionPhonetique.evolution_phonetique("BREVIÁRIU"))        #breviaire 5
print(EvolutionPhonetique.evolution_phonetique("MEDIETÁTE"))        #meitie 5
print(EvolutionPhonetique.evolution_phonetique("PEIIỌRE"))      #peiour 5
print(EvolutionPhonetique.evolution_phonetique("IMPASTRIÁRE"))    #empaistrier 5
print(EvolutionPhonetique.evolution_phonetique("DOMINICĘLLU"))  #domeisel 5
print(EvolutionPhonetique.evolution_phonetique("ROGATIỌNE"))         #rovaison 5
print(EvolutionPhonetique.evolution_phonetique("INTERROGÁRE"))         #enterver 5
print(EvolutionPhonetique.evolution_phonetique("IUDICÁRE"))         #jugier 5
print(EvolutionPhonetique.evolution_phonetique("CABALLICÁRE"))         #chevauchier 5
print(EvolutionPhonetique.evolution_phonetique("VERECỌNDIA"))         #vergoigne 5
print(EvolutionPhonetique.evolution_phonetique("MALEHÁBITU"))         #malade #5
print(EvolutionPhonetique.evolution_phonetique("AMÍCITATE"))         #amistie #5
print(EvolutionPhonetique.evolution_phonetique("MALEFẸCIU"))         #maleviz 5
print(EvolutionPhonetique.evolution_phonetique("MALEFATÚTU"))         #maufeu 5
print(EvolutionPhonetique.evolution_phonetique("MALIFÁTIU"))         #mauvais 5
print(EvolutionPhonetique.evolution_phonetique("QUARẸSIMA"))         #caresme 5
print(EvolutionPhonetique.evolution_phonetique("POTUISSẸMUS"))         #peussiens 5
print(EvolutionPhonetique.evolution_phonetique("PLACUISSẸMUS"))         #pleussiens 5
print(EvolutionPhonetique.evolution_phonetique("LEVIÁRIU"))         #legier 5
print(EvolutionPhonetique.evolution_phonetique("QUADRỌVIU"))         #carroge 5
print(EvolutionPhonetique.evolution_phonetique("EXAGIÁRE"))         #essaiier 5
print(EvolutionPhonetique.evolution_phonetique("FEBRUÁRIU"))         #fevrier 5
print(EvolutionPhonetique.evolution_phonetique("REPATRIÁRE"))         #repairier 5
print(EvolutionPhonetique.evolution_phonetique("COCHLEÁRIU"))         #cuillier 5
print(EvolutionPhonetique.evolution_phonetique("ABBREVIÁRE"))         #abregier 5
print(EvolutionPhonetique.evolution_phonetique("BATTUÁLIA"))         #bataille 5
print(EvolutionPhonetique.evolution_phonetique("ADDRECTIÁRE"))         #adrecier 5
print(EvolutionPhonetique.evolution_phonetique("ADDIURNÁRE"))         #ajorner 5
print(EvolutionPhonetique.evolution_phonetique("AGGENTIÁRE"))         #agencier 5
print(EvolutionPhonetique.evolution_phonetique("AGGREVIÁRE"))         #agregier 5
print(EvolutionPhonetique.evolution_phonetique("MAIIỌRE"))         #maiour 5
print(EvolutionPhonetique.evolution_phonetique("PIIITÁTE"))         #pitie 5
...
6 SYLLABES
"""
print(EvolutionPhonetique.evolution_phonetique("INSANGWILENTÁRE")) #ensanglenter
print(EvolutionPhonetique.evolution_phonetique("LIBERATIỌNE"))     #livreison 6
