    ...
    def syllabe_contrefinale(self, object):
        ...
        if len(syllabes[-4]) == 1:
            ...
            if syllabes[-4][0] + syllabes[-4][1] in listes_lettres['consonantisme_explosif_complexe']:
                ...
                #Les dentales combinées avec R se simplifient p.40-41
                    ...
                    if syllabes[-5][0] + syllabes[-5][1] == 'AL' or syllabes[-5][-1] == 'N':
                ...
                #la geminée s'amuit p.43
                    ...
                    if syllabes[-4][0] + syllabes[-4][1] == 'SW':
                        if syllabes[-5][-1] == 'N':
                            changements.append('')
                        else:
                ...
                #Gestion de T
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                        if syllabes[-5][-1] in listes_lettres['voyelles_toniques']:
                            ...
                            changements.append('')
                        elif syllabes[-4][1] == syllabes[-4][-1] in listes_lettres['voyelles_toniques']:
                            changements.append(syllabes[-4][0])
                    else:
            ...
            if syllabes[-4] == syllabes[1]:
                ...
                #Gestion de U:
                    ...
                    if syllabes[-4][-1] == 'U':
                        ...
                        if syllabes[-4][-1] + syllabes[-3][0] == 'LT':
                            changements.append('o')
                        elif syllabes[-4][-1] == 'N':
                            changements.append('o')
                        else:
                ...
                #Gestion de A tonique
                    ...
                    if syllabes[-4][-1] == 'Á':
                        ...
                        if len(syllabes) == 1:
                            if syllabes[-4][-1] == 'G' : #En ajouter d'autres, à chercher
                                changements.append('o')
                            else:
                                changements.append('a')
                ...
                #Gestion du E ouvert
                    ...
                    if syllabes[-4][-1] == 'Ę':
                        ...
                        if len(syllabes) > 1:
                            ...
                            elif syllabes[-4][-1] == syllabes[-1][-1] == 'R':
                                changements.append('a')
                            else:
                                changements.append('e')
                    elif syllabes[-4][-3] == 'Ę':
                ...
                #Gestion de I tonique
                    ...
                    if syllabes[-4][-1] == 'Í':
                        ...
                        if syllabes[-3][0] == syllabes[-1][-1] == 'O':
                            changements.append('u')
                        else:
                            changements.append('i')
                    elif syllabes[-4][-2] == 'Í':
                ...
                #Gestion de O fermé
                    ...
                    if syllabes[-4][-1] == 'Ọ':
                        ...
                        #Au contact d'un yod geminé  ou en milieu vélaire
                            ...
                            changements.append('u')
                        #Au contact d'un élément ou d'un groupe comportant ou dégageant un yod
                        elif syllabes[-4][-1] + syllabes[-3][0] in ['CT', 'SJ', 'LJ', 'CL', 'ST']:
                            changements.append('u')
                        else:
        ...
        #S'il n'y a pas de préfixes
            ...
            if 'E' in syllabes[-4]:
                if syllabes[-4][-1] == 'E':
                    if len(syllabes[-4]) > 2:
                        if syllabes[-4][-2] == syllabes[-4][0] == 'G':
                            if syllabes[-5][-1] == 'N':
                                changements.append('e')
                            else:
                                pass
                        elif syllabes[-4][0] + syllabes[-4][1] == 'TR':
                            changements.append(syllabes[-4][-1])
                        else:
                            changements.append('')
                    else:
