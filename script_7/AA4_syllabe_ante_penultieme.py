    ...
    def syllabe_ante_penultieme(self, object):
        ...
        if len(syllabes[-3]) == 1:
            ...
            if syllabes[-3][0] + syllabes[-3][1] in listes_lettres['consonantisme_explosif_complexe']:
                ...
                #Les dentales combinées avec R se simplifient p.40-41
                    ...
                    if syllabes[-4][0] + syllabes[-4][1] == 'AL' or syllabes[-4][-1] == 'N':
                ...
                #Les palatales combinées avec R s'affaiblissent toutes en [ir] p.41
                    ...
                    if syllabes[-4][-1] and syllabes[-3][2] in ['A', 'Á', 'E', "Ẹ", "Ę", 'I', 'Í']:
                        if syllabes[-3][2] in listes_lettres['voyelles_atones_sans_A'] and syllabes[-2][0] in listes_lettres['consonnes_nasales']:
                            changements.append(syllabes[-3][1])
                        else:
                ...
                #la geminée s'amuit p.43
                    ...
                    if syllabes[-3][0] + syllabes[-3][1] == 'SW':
                        if syllabes[-4][-1] == 'N':
                            changements.append('')
                        else:
                ...
                #Les palatales combinées au yod se redoublent
                    ...
                    #La palatale sourde s'assibile encore
                        ...
                        changements.append('i')
                elif syllabes[-3][0] + syllabes[-3][1] == 'RJ':
                    changements.append(syllabes[-3][0])
                elif syllabes[-3][0] + syllabes[-3][1] == 'LJ':
                    if syllabes[-4][-1] == 'I':
                        changements.append('ill')
                ...
                if syllabes[-3][0] == 'L':
                    ...
                    #Tous les autres cas
                        ...
                        if syllabes[-4][-1] == 'M':
                            ...
                            if syllabes[-4][-1] in listes_lettres['voyelles_atones_sans_A'] and syllabes[-4] != syllabes[0]:
                                changements.append('b' + syllabes[-3][0])
                            elif syllabes[-4][-1] == 'Ę':
                                changements.append(syllabes[-3][0])
                            else:
            ...
            if syllabes[-3] == syllabes[1]:
                ...
                #Gestion de U:
                    ...
                    if syllabes[-3][-1] == 'U':
                        ...
                        if syllabes[-3][-1] + syllabes[-2][0] == 'LT':
                            changements.append('o')
                        elif syllabes[-3][-1] == 'N':
                            changements.append('o')
                        else:
        ...
        #S'il n'y a pas de préfixes
            ...
            if 'E' in syllabes[-3]:
                if syllabes[-3][-1] == 'E':
                    if len(syllabes[-3]) > 2:
                        if syllabes[-3][-2] == syllabes[-3][0] == 'G':
                            if syllabes[-4][-1] == 'N':
                                changements.append('e')
                            else:
                                pass
                        elif syllabes[-3][0] + syllabes[-3][1] == 'TR':
                            changements.append(syllabes[-3][-1])
                        else:
                            changements.append('')
                    else:
            ...
            if 'O' in syllabes[-3]:
                if syllabes[-3][-1] == 'O':
                    if len(syllabes[-3]) == 1:
                        if syllabes[-3] == syllabes[-2][0] or syllabes[-2][0]:
                            changements.append(syllabes[-3])
                        else:
                            changements.append('')
                    else:
                        changements.append('')
