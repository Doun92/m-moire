...
'consonantisme_explosif_complexe' : ['BI', 'BL', 'BR', 'CH', 'CL', 'CR', 'CT',
 'DT', 'DR', 'DY', 'FL', 'FR', 'GL', 'GR', 'KW', 'LJ', 'LR', 'MR', 'NT',
 'PC', 'PJ', 'PL', 'PR', 'PS', 'PT', 'RD', 'RR',
 'SB', 'SC', 'SCR', 'SL', 'SN', 'SM', 'SP', 'SR', 'ST', 'STR',
 'TC', 'TL', 'TN', 'TR', 'VR', 'VT'],

'consonantisme_implosif_complexe': ['LL', 'MR', 'NC', 'NG', 'NK', 'NT', 'RG'],

'suffixes' : ['ÁRIU', 'DON', 'JAN'],

'prefixes': [],

'désinences_présent': ['BET', 'CET', 'DET', 'MUS', 'NET', 'NIT', 'PET', 'TET', 'VET'],
...
class SyllabeFinale:
    ...
    def syllabe_finale(self, object):
        ...
        if len(syllabes[-1]) == 1:
            pass
        elif syllabes[-1] in listes_lettres['désinences_subjonctif']:
            pass
        else:
            #D'abord l'algorithme vérifie s'il à affaire avec un élément consonantique complexe
            #Consonantisme explosif complexe
